use utf8;
package SequencesDB::Schema::Result::Tissue;
...
__PACKAGE__->has_many(
  ...
  { "foreign.tissue_tissue_id" => "self.tissue_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07043 @ 2015-07-08 11:50:11
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Esn+FWFyE5SR8Y3c1iBnUw
